...
ColorScheme buildSepiaScheme(Brightness brightness) {
  ...
  return ColorScheme(
    ...
    tertiaryContainer: AppPalettes.sepiaAccent.withOpacity(0.15),
    onTertiaryContainer: AppPalettes.sepiaTextPrimary,
    error: AppPalettes.sepiaError,
    onError: Colors.white,
    errorContainer: AppPalettes.sepiaError.withOpacity(.15),
    onErrorContainer: AppPalettes.sepiaTextPrimary,
    background: AppPalettes.sepiaBackground,
    onBackground: AppPalettes.sepiaTextPrimary,
    surface: AppPalettes.sepiaSurface,
    onSurface: AppPalettes.sepiaTextPrimary,
    surfaceVariant: AppPalettes.sepiaSurfaceVariant,
...
ColorScheme buildDeepBlueScheme(Brightness brightness) {
  return ColorScheme(
    ...
    onTertiary: Colors.white,
    tertiaryContainer: AppPalettes.deepAccent.withOpacity(0.15),
    onTertiaryContainer: AppPalettes.deepTextPrimary,
    error: AppPalettes.deepError,
    onError: Colors.white,
    errorContainer: AppPalettes.deepError.withOpacity(.15),
    onErrorContainer: AppPalettes.deepTextPrimary,
    background: AppPalettes.deepBackground,
    onBackground: AppPalettes.deepTextPrimary,
    surface: AppPalettes.deepSurface,
    onSurface: AppPalettes.deepTextPrimary,
    surfaceVariant: AppPalettes.deepSurfaceVariant,
